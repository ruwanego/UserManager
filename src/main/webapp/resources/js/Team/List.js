...
$(document).ready(function() {
	oTable = $('#teamtable').dataTable({
		...
		"bProcessing" : true,
		"bServerSide" : true,
		"sAjaxSource" : "/domain/teams/",
		"aoColumns" : [ {"mData" : "id" },
		                {"mData" : "teamName"}
		               ],
		"aoColumnDefs": [
		                 { "sName": "id",   "aTargets": [ 0 ] },
		                 { "sName": "teamName",  "aTargets": [ 1 ] },
...
function initCrudButtons(){
	$("div.toolbar").html('<a href="/domain/teams/create" id="bt_add" class="btn btn-primary">Create</a> <a href="#" id="bt_update" class="btn btn-success">Edit</a> <button id="bt_delete" type="button" class="btn btn-danger">Delete</button>');
	...
	$("#bt_update").click(function() {
		if (selected_id == null) {
			...
			$("#bt_update").attr("href", "/domain/teams/update/" + selected_id);
		}
	});
